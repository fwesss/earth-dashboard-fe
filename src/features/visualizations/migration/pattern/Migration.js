...
export default withErrorBoundary(() => {
    ...
    return (
        ...
        >
            ...
            <VisExplanation>
                A density plot allows us to check the distribution of a numeric variable. 
                This is useful when examining a new dataset. 
                A ridgeline plot such as this one lets us look at the distribution of bird observations amongst several groups. 
                In this case, each group is the migration for that year. 
                Each ‘observation’ is the number of sightings for a particular species.
            </VisExplanation>
            <BirdPatternQuiz />
        </Box>
    );
