...
export default withErrorBoundary(() => {
    ...
    return (
        ...
        >
            ...
            <VisExplanation>
                The spring migration of birds was at one point in time as predictable as the seasons.
                Bird migration peaks as the amount of daylight increases, as it suggests to the birds
                that their destinations will have plentiful food and resources with the arrival of summer.
                However, as the seasons have become less predictable with the advent of increasing climate change,
                so too have the patterns of bird migrations become more varied. Bird observations during the peak of
                the season have decreased between 1970 and today, suggesting that the peak of the season is now earlier.
                Similar data suggests that the populations of various species may be decreasing.
      </VisExplanation>
            <BirdPatternQuiz />
        </Box>
    );
